...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2022 at 12:28 AM
...
(3, '2020_03_15_115956_create_product_table', 1),
(4, '2022_03_15_104111_create_supplier_table', 1),
(5, '2022_03_15_115919_create_category_table', 1),
(6, '2022_03_15_120016_create_brand_table', 1),
(7, '2022_03_22_203449_create_sale_table', 1),
(8, '2022_03_23_093914_create_order_table', 1),
(9, '2022_03_16_103430_create_purchase_table', 1);
...
CREATE TABLE `sale` (
  ...
  `iteams` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `supplier` (
  ...
  `supplier_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_Phone_num` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
